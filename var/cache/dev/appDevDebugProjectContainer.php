...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.order.from.cart.service' => 'getApp_Order_From_Cart_ServiceService',
            'app.order.service' => 'getApp_Order_ServiceService',
            'app.ordered.products.service' => 'getApp_Ordered_Products_ServiceService',
            'app.product.history.service' => 'getApp_Product_History_ServiceService',
            'app.supply.manager.service' => 'getApp_Supply_Manager_ServiceService',
            ...
            'product.history' => 'getProduct_HistoryService',
            ...
            'supply.products' => 'getSupply_ProductsService',
    ...
    /**
     * Gets the 'app.order.from.cart.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Utils\CartManager A AppBundle\Utils\CartManager instance
     */
    protected function getApp_Order_From_Cart_ServiceService()
    {
        return $this->services['app.order.from.cart.service'] = new \AppBundle\Utils\CartManager($this->get('cart'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['app.ordered.products.service'] = new \AppBundle\Utils\OrderedProductsManager($this->get('ordered.products'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.product.history.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Utils\ProductHistoryManager A AppBundle\Utils\ProductHistoryManager instance
     */
    protected function getApp_Product_History_ServiceService()
    {
        return $this->services['app.product.history.service'] = new \AppBundle\Utils\ProductHistoryManager($this->get('supply.products'), $this->get('ordered.products'), $this->get('doctrine.orm.default_entity_manager'), $this->get('product.history'));
    }

    /**
     * Gets the 'app.supply.manager.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Utils\SupplyManager A AppBundle\Utils\SupplyManager instance
     */
    protected function getApp_Supply_Manager_ServiceService()
    {
        return $this->services['app.supply.manager.service'] = new \AppBundle\Utils\SupplyManager($this->get('supply.products'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KBICwja9Bk', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gK4scjYj7k', 0, 'TosqXsPAJJ0nNdcrFj3dvl', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eQFRIB6h7+', 0, 'TosqXsPAJJ0nNdcrFj3dvl', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3ZXoQ04+Ao', 0, 'TosqXsPAJJ0nNdcrFj3dvl', (__DIR__.'/pools'), $a));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Cart A AppBundle\Entity\Cart instance
     */
    protected function getCartService()
    {
        return $this->services['cart'] = new \AppBundle\Entity\Cart($this->get('user'), $this->get('products'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_50b460b8c60c975df2cda31f5747fd72fee1677988c071c7dc694f290eb3445a');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('registered@shop.com' => 'Shop says Hi'), 'resetting' => array('mientuma@wp.pl' => 'Matiq'))));
    }
    ...
    {
        return $this->services['jms_i18n_routing.loader'] = new \JMS\I18nRoutingBundle\Router\I18nLoader(new \JMS\I18nRoutingBundle\Router\DefaultRouteExclusionStrategy(), new \JMS\I18nRoutingBundle\Router\DefaultPatternGenerationStrategy('prefix_except_default', $this->get('translator'), array(0 => 'de', 1 => 'en', 2 => 'fr', 3 => 'pl'), __DIR__, 'routes', 'en'));
    }
    ...
    /**
     * Gets the 'product.history' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Utils\ProductHistory A AppBundle\Utils\ProductHistory instance
     */
    protected function getProduct_HistoryService()
    {
        return $this->services['product.history'] = new \AppBundle\Utils\ProductHistory();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Products A AppBundle\Entity\Products instance
     */
    protected function getProductsService()
    {
        return $this->services['products'] = new \AppBundle\Entity\Products();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = $this->get('security.authentication.rememberme.services.simplehash.main');
        $h = $this->get('http_kernel');
        $i = $this->get('security.authentication.manager');
        $j = $this->get('security.authentication.session_strategy');
        $k = $this->get('debug.security.access.decision_manager');
        ...
        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/order');
        ...
        $r = new \Symfony\Component\Security\Http\HttpUtils($f, $f);
        ...
        $t->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => 'homepage', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $t->setProviderKey('main');

        $u = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($h, $r, array(), $a);
        ...
        $v = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $i, $j, $r, 'main', $t, $u, array('require_previous_session' => false, 'check_path' => 'fos_user_security_check', 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, $this->get('security.csrf.token_manager'));
        $v->setRememberMeServices($g);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($q, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c, 1 => new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:User', 'username', NULL)), 'main', $a, $d, $e), 2 => $s, 3 => $v, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $g, $i, $a, $d, true, $j), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58b422ecf376a5.24848719', $a, $i), 6 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker.main'), 'main', $k, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $k, $q, $i)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $r, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($h, $r, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 604800, 'cookie_httponly' => true, 'gc_probability' => 1), $this->get('session.handler'), $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the 'supply.products' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\SupplyProducts A AppBundle\Entity\SupplyProducts instance
     */
    protected function getSupply_ProductsService()
    {
        return $this->services['supply.products'] = new \AppBundle\Entity\SupplyProducts();
    }
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'iiyvbfau@sharklasers.com'), array());
    }
    ...
    {
        return $this->services['user'] = new \AppBundle\Entity\User();
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.mailer.default.single_address' => 'iiyvbfau@sharklasers.com',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'iiyvbfau@sharklasers.com',
            ),
            ...
            'swiftmailer.single_address' => 'iiyvbfau@sharklasers.com',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'registered@shop.com' => 'Shop says Hi',
            ),
