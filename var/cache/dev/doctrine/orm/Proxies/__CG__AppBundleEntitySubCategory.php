...
class SubCategory extends \AppBundle\Entity\SubCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SubCategory' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\SubCategory' . "\0" . 'parentId', '' . "\0" . 'AppBundle\\Entity\\SubCategory' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\SubCategory' . "\0" . 'category', '' . "\0" . 'AppBundle\\Entity\\SubCategory' . "\0" . 'products'];
        }
