 ...
 */
class Delivery extends \AppBundle\Entity\Delivery implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Delivery' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Delivery' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Delivery' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Delivery' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Delivery' . "\0" . 'orders'];
        }
